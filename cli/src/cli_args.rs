...
use crate::whitelist_management::WhitelistManagementCommands;

#[derive(Parser)]
#[command(author, version, about = "A CLI for managing Whitelist operations", long_about = None)]
pub struct Cli {
    #[command(subcommand)]
    ...
    #[arg(long, global = true, help = "Jito Whitelist Management program ID")]
    pub jito_whitelist_management_program_id: Option<String>,
...
pub enum ProgramCommand {
    ...
    WhitelistManagement {
        #[command(subcommand)]
        action: WhitelistManagementCommands,
    },
}
